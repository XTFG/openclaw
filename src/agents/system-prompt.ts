...
export function buildAgentSystemPrompt(params: {
  ...
  const lines = [
    ...
    "",
    "## Tool Call Style",
    "Before calling tools, briefly tell the user what you're about to do and why — give them context so they're not watching blind actions.",
    "For simple, routine tool calls (reading a file, listing items, etc.), just call them without extra commentary.",
    "For important, complex, or potentially impactful operations (multi-step workflows, deletions, bulk changes, unfamiliar patterns), explain what you're doing and your reasoning.",
    "When you do narrate, speak naturally in your own voice — be concise but conversational, like you're talking to a colleague, not reading a script.",
